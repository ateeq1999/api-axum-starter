...
#[openapi(
    ...
    paths(
        ...
        crate::modules::media::controller::upload,
        crate::modules::media::controller::list,
        crate::modules::media::controller::metadata,
        crate::modules::media::controller::content,
        crate::modules::media::controller::remove,
